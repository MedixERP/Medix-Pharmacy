...
export default function Navbar({ sidebarOpen, setSidebarOpen }: NavbarProps) {
  ...
  return (
    ...
    >
      ...
      {/* ================= اليمين: الإشعارات + البحث للموبايل + حساب الـ Supplier المتكامل ================= */}
      <div className="flex items-center gap-2 sm:gap-4 relative" ref={dropdownRef}>
        ...
        {/* كارت البروفايل: أفتار وتكست في التابلت واللابتوب، ويتحول لأفتار فقط في الموبايل */}
        <div 
